...
public class CartRecylerViewAdapter_For_Fragment extends RecyclerView.Adapter <CartRecylerViewAdapter_For_Fragment.ViewHolder> {
    ...
    public CartRecylerViewAdapter_For_Fragment(List<CartDbModel> cartList, Context cartActivity, Fragment myfragment) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CartRecylerViewAdapter_For_Fragment.ViewHolder viewHolder = new CartRecylerViewAdapter_For_Fragment.ViewHolder(view);
        return viewHolder;
    }
            ...
            public void onClick(View v) {
                ...
                new AsyncTask<CartDbModel, Void, Integer>() {
                    ...
                    protected void onPostExecute(Integer number) {
                      ...
                      fragment_cart.TotalTextView.setText(utilities.calculateTotal(cartList)+ " BDT");
