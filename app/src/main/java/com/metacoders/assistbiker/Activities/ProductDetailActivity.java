...
//
        sliderItems.add(new sliderItem(Constants.IMAGE_URL + singleProduct.getProduct_img1())) ;
        sliderItems.add(new sliderItem(Constants.IMAGE_URL + singleProduct.getProduct_img2())) ;
        sliderItems.add(new sliderItem(Constants.IMAGE_URL + singleProduct.getProduct_img3())) ;
